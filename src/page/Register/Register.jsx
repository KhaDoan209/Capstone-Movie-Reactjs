...
export default function Register() {
  ...
  return (
    <div className='formdk'>
      <h2 className='text-center ' style={{fontSize :50, fontWeight:500}}>Đăng Ký</h2>
      <form onSubmit={formik.handleSubmit}>
        ...
        {/* <div className="form-group">
          ...
          <select onChange={formik.handleChange}  className='form-control 'name="maNhom" id="">
        ...
        <div className="form-group">
          ...
          <input type="text" className="form-control" name="maNhom" onChange={formik.handleChange} />
          {/* {formik.errors.soDt ? (
            <div className='alert alert-danger'>{formik.errors.soDt}</div>
          ) : null} */}
        ...
        <div className="form-group">
          <button className='btn btn-info'>Đăng ký
          </button>
