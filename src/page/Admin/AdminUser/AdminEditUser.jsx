...
export default function AdminEditUser(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            let action = capNhatuser(values)
            dispatch(action)
        },
    });
    return (
        <div className='formdk container'>
            <h2 className='text-center ' style={{ fontSize: 50, fontWeight: 500 }}>Cập Nhật Người Dùng</h2>
            <form onSubmit={formik.handleSubmit}>
                <div className="form-group">
                    <label htmlFor="">Tài khoản</label>
                    <input type="text" className="form-control" name='taiKhoan' onChange={formik.handleChange}  value={formik.values.taiKhoan}
                ...
                <div className="form-group">
                    ...
                    <input type="password" className="form-control" name='matKhau' onChange={formik.handleChange} onBlur={formik.handleBlur}  value={formik.values.matKhau}
                    // value={formik.values.taiKhoan}
                    />
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" name="hoTen" onChange={formik.handleChange}  value={formik.values.hoTen} />
                    {formik.errors.hoTen ? (
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" name="soDt" onChange={formik.handleChange}   value={formik.values.soDt}/>
                    {formik.errors.soDt ? (
                ...
                <div className="form-group">
                    ...
                    <select onChange={formik.handleChange} className='form-control ' name="maLoaiNguoiDung" id=""  value={formik.values.maLoaiNguoiDung}>
                ...
                <div className="form-group">
                    <button className='btn btn-info'>LƯU
                    </button>
